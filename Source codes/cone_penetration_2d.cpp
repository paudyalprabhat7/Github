...
int main() {
    ...
    auto input_xyz = sampler.SampleBox(fill_center, make_float3(fill_radius, 0.f, fill_height / 2.));

    //earlier cylindrical sampling
    //sampler.SampleCylinderZ(fill_center, 0.f, fill_height / 2 - scale * 2.);
