...
int main() {
    ...
    auto mat_type_cube = DEMSim.LoadMaterial({{"E", 2.1e9}, {"nu", 0.3}, {"CoR", 0.6}, {"mu", 0.3}, {"Crr", 0.01}});
    auto mat_type_terrain = DEMSim.LoadMaterial({{"E", 1e9}, {"nu", 0.3}, {"CoR", 0.8}, {"mu", 0.65}, {"Crr", 0.01}});
    auto mat_type_analyticalb = DEMSim.LoadMaterial({{"E", 2.1e9}, {"nu", 0.3}, {"CoR", 0.6}, {"mu", 0.3}, {"Crr", 0.01}});
    ...
    out_dir += "/Output_settlingphase_fromscratch";
